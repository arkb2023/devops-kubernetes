...
NAMESPACE="staging"
PV_NAME="staging-local-pv"

echo "🚀 Nuclear Staging Cleanup Starting..."
...
echo "🎉 Ready for redeploy: kustomize build apps/the-project/overlays/staging | kubectl apply -f -"
